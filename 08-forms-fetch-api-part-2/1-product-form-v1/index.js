...
export default class ProductForm {
  ...
  _setImageData() {
    const images = this._formData.images;

    images.forEach(image => this._addPhotoItem(image));
  }
  ...
  _addPhotoItem(img) {
    ...
    wrapper.innerHTML = this._createTemplateProductPhotoItem(img);
    const photoItem = wrapper.firstElementChild;

    // noinspection JSUnresolvedVariable
    this.subElements.imageListContainer.append(photoItem);
  }
